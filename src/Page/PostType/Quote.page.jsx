				...
				<div className="flex gap-12 mb-20">
					...
					<div className="w-[70%] ">
						<div className="flex flex-col items-start space-y-4 ">
							<div className="bg-pink-50  py-16 px-5 mt-28   mb-14">
								<p className="text-center italic leading-9 tracking-wider  text-[#8d6759] mx-auto text-2xl ">
									...
									I have experienced. Recommend it to all.
								</p>

								<h1 className=" text-[#a38479] cursor-pointer mt-4 hover:text-[#c09d90]  text-center text-md tracking-[1px] font-serif ">
