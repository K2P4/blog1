...
import { useGetBeautyTwoQuery } from "../service/endpoints/BlogEndpints";
...
const BeautyTwoComponent = () => {
	const { data, isLoading } = useGetBeautyTwoQuery();
...
export default BeautyTwoComponent;
