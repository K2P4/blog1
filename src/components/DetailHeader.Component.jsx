					...
					<div className="flex flex-col items-start space-y-4 ">
						...
						<div className="  relative DetailParaFont  gap-3 text-justify  ">
							...
							<p className=" text-[#424242]   text-xl  mt-3 text-wrap  tracking-wide leading-[30px]">
								...
								at minim labores. Tollit ullamcorper ius cu, eos malis clita
								luptatum ei, vix ullum forensibus an. Esse option singulis id
								nec, nam eruditi ornatus at. Eam soluta dicunt cu. Est ad
								oporteat appellantur, per dicta pertinax cu. Iusto quando
								conceptam vim ad, an sed explicari appellantur. Augue utamur
								lobortis vim ne.
							</p>
						</div>
						...
						<div className=" text-left flex flex-col space-y-8 ">
							...
							<p className=" text-[#727272]     text-lg  text-wrap  tracking-wide leading-[30px]">
								...
								sit. Etiam rhoncus. Tempus, tellus eget condimentum rhoncus, sem
								quam semper libero, amet et sem adipiscing sem neque nula ipsum.
								Etiam ultricies nisi vel augue blandit vel, luctus pulvinar
							</p>
						</div>
						...
						<div className="  relative DetailParaFont  gap-3   ">
							...
							<p className=" text-[#424242]   text-xl  mt-3 text-wrap  tracking-wide leading-[30px]">
								...
								constituam te his, meis euismod sed ad. Partem suscipit cu cum.
								Vix no prodesset complectitur concludaturque, dicam perfecto eu
								per, ne vis eleifend expetenda. Idque petentium laboramus mea
								id, mei at minim labores. Quaestio omittantur id usu. Pri ei
								facilis definitionem. Meis moderatius consectetuer nam an,
								populo praesent mea in, euismod dissentiet definitionem.
							</p>
						</div>
						...
						<div className=" space-y-4 ">
							<p className="text-[#727272]     text-left  text-lg    tracking-wide leading-[30px]">
								...
								debitis cum. Vix paulo evertitur cu, conceptam constituam te
								his, meis euismod sed ad. Partem suscipit cu cum. Vix no
								prodesset complectitur concludaturque, dicam perfecto eu per, ne
								vis eleifend expetenda. Pa sea dicta dicant equidem, est cu
							...
							<p className="text-[#727272]     text-left  text-lg    tracking-wide leading-[30px]">
								...
								id, mei at minim labores. Quaestio omittantur id usu. Pri ei
								facilis definitionem. Meis moderatius consectetuer nam an,
								populo praesent mea in, euismod dissentiet definitionem quo ne.
							</p>
						</div>
						...
						<div className=" space-y-7 ">
							...
							<p className="text-[#727272]     text-left  text-lg    tracking-wide leading-[30px]">
								...
								ultricies nisi vel augue. Lorem ipsum dolor sit amet, consectetu
								adipiscing elit. Aenean commodo ligula eget dolor. Cum socis
								Theme sed natoque ut penatibus. Etiam ultricies nisi vel augue.
								Cura bitur tincidunt ultricies dictum felis eu pede sit. Etiam
								rhoncus. Sem quam semper libero, amet et adipiscing sem neque
								nula ipsum. Etiam ultricies nisi vel augue blandit vel, luctus
								pulvinar.
							</p>
						</div>
