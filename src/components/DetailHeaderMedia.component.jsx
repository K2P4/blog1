...
import ReplySessionComponent from "./Comment/ReplySession.component";
import UserCommentComponent from "./Comment/UserComment.component";

const DetailHeaderMediaComponent = () => {
	const { id } = useParams();
		...
		<div className="flex gap-12 ">
			...
			<div className="w-[70%] ">
				<div className="flex flex-col items-start space-y-4 ">
					...
					<UserCommentComponent setUserData={setUserData} userData={userData} />
...
export default DetailHeaderMediaComponent;
