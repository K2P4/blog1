...
import { useGetInspiration2Query } from "../service/endpoints/BlogEndpints";
import ContainerComponent from "./Container.component";

const InspirationTwoComponent = () => {
	const { data, isLoading } = useGetInspiration2Query();
...
export default InspirationTwoComponent;
