...
const navigationMenuTriggerStyle = cva(
	"group inline-flex  duration-1000 w-max items-center justify-center rounded-md bg-white px-6  text-xs  transition-colors   py-10 focus:text-slate-900  disabled:pointer-events-none disabled:opacity-50 data-[active] data-[state=open] dark:bg-slate-950    dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:data-[active] dark:data-[state=open] "
);
